...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/active-project-info.js"></script>
</head>
<body>
<main>
    ...
    <table class="act-project-info-table">
            ...
            <td colspan="4"  style="text-align: left" valign="top">
                <div class="container">
                    <table class="inner-act-project-info-table" id="act-project-info-table-id">
                        ...
                        <tr>
                            <td colspan="4" style="text-align: left"><p id="description-info-id">Some info about project</p></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
        ...
        <tr>
            ...
            <td colspan="2"  style="text-align: center" valign="top">
                <button class="btn btn-primary" id="close-active-project-info-id">Ok</button>
            </td>
            <td></td>
        </tr>
        </tfoot>
